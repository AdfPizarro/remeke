...
function sendAnswer(id){
  ...
  $(".carrouselContent").empty();
   var content='<div class="flip-card"><div class="card flip-card-inner"><div class="flip-card-front"><span class="badge badge-warning">Rarámuri</span>'+
     words[x].rar
   +' </div><div class="flip-card-back"><span class="badge badge-warning">Español</span>'+
     words[x].spa
   +'</div></div></div> ';
...
function drawCarouselContent(words, x){
  $(".catTitle").empty()
  $(".catTitle").append(currentCat);

 $(".carrouselContent").empty();
  var content='<div class="flip-card"><div class=" flip-card-inner"><div class=" flip-card-front card-header"><span class="badge badge-warning">Rarámuri</span>'+
    words[x].rar
  +' </div><div class="card-body flip-card-back"><span class="badge badge-warning">Español</span>'+
    words[x].spa
  +'</div></div></div> ';
